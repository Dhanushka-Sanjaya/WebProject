...
<div class="archive-title-area">		
        <h1 class="page-introduce-title"><?php echo count($posts); ?></strong> <?php printf( esc_html__( 'Posts for <strong>%s</strong> Tag', 'elletta' ), single_tag_title( '', false ) ); ?></h1>		
</div>
<?php 
            ...
            <div class="container<?php if( $elletta_sidebar_page != 'none' ) : ?> sidebar-open clearfix<?php endif; ?> <?php echo esc_attr($elletta_layout_page); ?>-container <?php echo esc_attr($elletta_sidebar_page); ?>">
                    <div id="content" class="post">
                            <div class="entry-content">
                                    <h2><?php esc_html_e( "We Can't Find Anything For", 'elletta' ); ?> <span class="search-query"><?php echo single_tag_title( '', false ); ?></span></h2>
