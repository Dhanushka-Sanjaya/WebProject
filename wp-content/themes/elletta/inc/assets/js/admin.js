...
$(document).ready(function(e) {
	...
	// Video Options
	var video_list_checked = $("input[name='elletta_video_list']:checked");
	video_list_open(video_list_checked);
	
	$("input[name='elletta_video_list']").change(function(){
		video_list_open($(this));
	})

	// Audio Options
	var audio_list_checked = $("input[name='elletta_audio_list']:checked");
	audio_list_open(audio_list_checked);
	
	$("input[name='elletta_audio_list']").change(function(){
		audio_list_open($(this));
	})

	// Gallery Options
	var gallery_list_checked = $("input[name='elletta_gallery_layout']:checked");
	gallery_list_open(gallery_list_checked);
	
	$("input[name='elletta_gallery_layout']").change(function(){
